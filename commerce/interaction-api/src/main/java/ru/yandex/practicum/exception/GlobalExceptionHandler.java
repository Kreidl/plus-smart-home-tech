...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CartActivationException.class)
    public ErrorResponse handleCartActivationException(
            CartActivationException e) {
        log.warn(e.getMessage());
        return new ErrorResponse("Cart deactivated", e.getMessage(), LocalDateTime.now());
    }

    @ResponseStatus(HttpStatus.NOT_FOUND)
    @ExceptionHandler(NoProductsInShoppingCartException.class)
    public ErrorResponse handleNoProductsInShoppingCartException(
            NoProductsInShoppingCartException e) {
        log.warn(e.getMessage());
        return new ErrorResponse("Shopping cart error", e.getMessage(), LocalDateTime.now());
    }
    ...
    public ErrorResponse handleNoSpecifiedProductInWarehouseException(
        ...
        log.warn(e.getMessage());
        return new ErrorResponse("Warehouse error", e.getMessage(), LocalDateTime.now());
    }
    ...
    public ErrorResponse handleProductNotFoundException(
        ...
        log.warn(e.getMessage());
        return new ErrorResponse("Product not found", e.getMessage(), LocalDateTime.now());
    }
    ...
    public ErrorResponse handleSpecifiedProductAlreadyInWarehouseException(
        ...
        log.warn(e.getMessage());
        return new ErrorResponse("Duplicate in warehouse", e.getMessage(), LocalDateTime.now());
    }
    ...
    public ErrorResponse handleProductInShoppingCartLowQuantityInWarehouse(
        ...
        log.warn(e.getMessage());
        return new ErrorResponse("Not enough products in warehouse", e.getMessage(), LocalDateTime.now());
    }

    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    @ExceptionHandler(UserAuthorizationException.class)
    public ErrorResponse handleUserAuthorizationException(
